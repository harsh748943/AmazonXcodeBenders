...
//            fetchAndGenerateBudgetPlan();
     ...
     */
    private void calculateAndDisplayBudgetPlan(List<Transaction> historicalTransactions, double avgIncome) {
        ...
        double recommendedMonthlySavings = avgMonthlyIncome * 0.15;
